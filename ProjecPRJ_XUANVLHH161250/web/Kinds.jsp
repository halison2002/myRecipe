<%-- 
    Document   : Kind
    Created on : 07-Mar-2023, 23:21:18
    Author     : Le Vu
--%>
                ...
                <c:when test="${sessionScope.acc != null && sessionScope.acc.role == 1}">
                    ...
                    <div id="content">
                        ...
                        <div id="content-right">
                                ...
                                <div class="table-responsive">
                                    <div class="table-wrapper">
                                        <div class="table-title">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <h2>Manage Kinds</b></h2>
                                                </div>
                                                <div class="col-sm-6">
                                                    <a href="#addKindModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Kind</span></a>
                                                </div>
                                            </div>
                                        </div>                                                                                  
                                            ...
                                            <tbody>
                                                <c:forEach items="${a.allKind}" var="k">
                                                    <tr>
                                                        ...
                                                        <td>${k.quantity}</td>
                                                        <td>
                                                            <a href="deleteKind?id=${k.id}" class="delete"><i class="material-icons" title="Delete">&#xE872;</i></a>
                                                        </td>
                                                    </tr>
                                                </c:forEach>       
                            ...
                            <!-- Edit Modal HTML -->
                            <div id="addKindModal" class="modal fade">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form action="addKind" method="post">
                                            <div class="modal-header">						
                                                <h4 class="modal-title">Add Kind</h4>
