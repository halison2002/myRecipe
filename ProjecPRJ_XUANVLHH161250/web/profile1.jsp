    ...
    <div id="container">
        ...
        <div id="content">
            ...
            <div id="content-right" style="border: 1px #ec9393; padding: 5px;">
                <div class="path">Favorite list</b></div>
                ...
                <c:forEach items="${listR}" var="o">
                    <div class="Recipe" style="margin-bottom: 5px">
                        <div style="display: flex">
                            ...
                            <div style="flex: 1">
                                <div><a href="Detail?rid=${o.id}">${o.name}</a>
                                <a href="deleteFavoriteRecipe?rid=${o.id}" class="delete"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                </div>
