  ...
  <jsp:include page="header.jsp"></jsp:include>
    <div id="content">
      ...
      <div id="content-right">         
        <div class="path">Most Favorite</b></div>
        <div class="content-main" style="display:flex">
            <c:forEach  items="${a.getTopFavorite()}" var="o">
                <div class="product">
        ...
        <div class="path">QUICK & YUMMY</b></div>
        <div class="content-main" style="display:flex">
            <c:forEach items="${a.getTopQuick()}" var="o">
                <div class="product">
                    <a href="Detail?rid=${o.id}"><img src="assets/img/${o.picture}" width="100%"/></a>
                    <div class="name"><a href="Detail?rid=${o.id}">${o.name}</a></div>
                    <div class="price" style="color: #E96479; font-size: 12px; font-style: italic ">${o.time} minutes</div>
        ...
        <div class="path">NEW RECIPES</b></div>
        <div class="content-main" style="display:flex">
        <c:forEach items="${listR}" begin="0" end="3" var="o">
                <div class="product">
                    <a href="Detail?rid=${o.id}"><img src="assets/img/${o.picture}" width="100%"/></a>
                    <div class="name"><a href="Detail?rid=${o.id}">${o.name}</a></div>
                    <div class="price" style="color: #E96479; font-size: 12px; font-style: italic ">${o.time} minutes</div>
