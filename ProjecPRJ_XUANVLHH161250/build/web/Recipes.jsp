<%-- 
    Document   : Recipes
    Created on : 07-Mar-2023, 23:23:21
    Author     : Le Vu
--%>
...
<!--                                            <th>
                                    ...
                                    <tbody>
                                        <c:forEach items="${a.allRecipe}" var="o">
                                            <tr>
<!--                                                <td>
                                                    <span class="custom-checkbox">
                                                ...
                                                <td>${o.kindId}</td>
                                                <td>${o.authorId}</td>
						<td><img src="assets/img/${o.picture}" width="80%"/></td>
                                                <td></td>
                                                <td>${o.description}</td>
                                                <td>${o.time} minutes</td>
                                                <td>
                                                    <a href="deleteRecipe1?rid=${o.id}" class="delete"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                    ...
                    <div id="addRecipeModal" class="modal fade">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form action="addRecipe1" method="post">
